...
*  Evaluating the model results by checking convergence, analytical solutions and water/heat balances (sections [Solving and checking convergence], [Comparing with the analytical solution], [Examining the water balance] _exercise 11, 12, 14, 15_ and sections [Testing different resolutions], [**Exta assignment**: Surface flux as a Cauchy/Robin boundary] _exercise 5,14_)
...
Ik verwijs naar de eerste figuur \@ref(fig:1D2rivers)
