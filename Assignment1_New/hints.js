...
dict[2] = "You can use the nodes-vector to calculate the analytical solution for all x positions at the same time. Use substraction to look at the difference with the modelled heads. You can use the *dataframe.states()* function to get the modelled heads.";
dict[3] = "(To be added: Explanation on Monin-Obukhov length/atmospheric stratification)";
