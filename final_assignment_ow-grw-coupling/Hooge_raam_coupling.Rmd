...
properties: Weir: crest width 2.0 m, crest height: 11.45 and 12.60 m.
...
::: question
Finish the functions in the chunck below (replace XXXX, YYYY). These
XXXX and YYYY only indicate that you have to fill in the correct values.
It does not mean that all XXXX or YYYY are the same.
...
$\frac {\text{total_drained_area}}{\text{average ditch_distance}}$ .
...
m2.day.to.m3.day =   HR.discharge.area/L #from m2/day to m3/day; a "total diffuse length" based on the total drained area divided by the L(ditch distance)
...
day2sec = 86400
m2.day.to.m3.day = HR.discharge.area/L #multiply with "total diffuse length"; i.e. Area/drain_distance
...
GW.volume.storage_outof = sum(GW.Q.trans$flow_2storage) * m2.day.to.m3.day * delt.t
