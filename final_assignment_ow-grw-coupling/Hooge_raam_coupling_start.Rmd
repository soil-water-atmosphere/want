...
```{r eval=FALSE, animation.hook='gifski', interval= 0.25}
...
The max. precipitation is at day `time.max.precip` (blue vertical
line) and the max. discharge is at day : `time.max.discharge` (red
vertical line)
...
`HR.Q.trans$boundary_downstream[time.max.discharge]` in $m^3/s$ and
takes place at time : `HR.Q.trans$time[time.max.discharge]` days.
