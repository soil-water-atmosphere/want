...
*  Understanding the difference between linear and nonlinear system flow functions *(Exercise 8)*
...
<div class="exercise"> 
4. Implement the new eddy diffusivity $K_{eddy}$ that depends on the surface heat flux. Use a heat flux of -0.025 $K m s^{-1}$ at the surface (downwards heat flux). 
</div>
...
<div class="exercise">	
6. If the flux at the surface does not equal the prescribed surface heat flux, adapt the boundary conditions at the surface in such a way that the flux of energy at the surface equals the prescribed surface energy flux. 
</div>
...
<div class="exercise"> 
11. Check the balance of the system. Is the net inflow over the boundaries equal to the total external flux? 
</div>
