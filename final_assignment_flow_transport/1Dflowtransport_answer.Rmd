...
plot(mass.begin,type="o", main = "mass at the beginning of the remediation kg/m")
grid()
...
plot(mass.left,type="o", main = "mass left in the model kg/m")
grid()
...
This can be calculated by setting up the mass balance for the transport model for each time step and analyze the total amount of mass extracted by the well. This amount is tracked by the data frame `tot.pump.treat`
