...
This can be calculated by setting up the mass balance for the transport model for each time step and analyze the total amount of mass extracted by the well. This data is stored the mass balance and can be calculated by:
This amount is tracked by the data frame `tot.pump.treat`
...
For 1. the concentration distribution in time and space in tracked in `C_trans`.  
