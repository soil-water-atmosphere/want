...
subtitle: "Groundwater flow towards rivers and Heat transfer in the atmospheric boundary layer"
date: "March 2019"
output:
...
The 'answer' version will be available on Blackboard when suitable.  

This docouments is meant to be self contained, meaning that all aspects required to work with it, are included.  

Simply load this *.Rmd document into R-studio and "knit" of "preview" this document and have a look at the created html (in the previewer of R-studio or in a browser)
