...
<div class="answer">
14. $\frac{\partial \psi}{\partial z}$ is now constant, thus the state distribution is linear because the internal flux is now switched to a linear type of equation since the $k_{sat}$ has become a constant. 
</div>
