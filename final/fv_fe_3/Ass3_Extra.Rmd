...
set.BC.fixedflux(UnsatStat,"right",0.1) #reset
```
...
We will look at the effects of using finite element discretisation methods in a model with a coarse spatial discretisation ánd a very dry soil, causing the flux function (incl. K) to become very nonlinear.
...
UnsatTrans_Coarse=copy.model(UnsatTrans)
...
<div class="comment">
The answer needs some explanation! Why do FE-quadratic and higher manage to solve this? 
</div>

<div class="comment">
COMMENT: deze Markdown kan niet knitten, is dat erg?
</div>