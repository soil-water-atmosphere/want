...
To cycle through the time steps $\Delta t$ of 0.5 $d$ starting at **begin.time** and finalizing at **end.time**, a time loop needs to be implemented. Use the pseudo-code of the meteorological exercise in Section 1.4.2 as a reference.
