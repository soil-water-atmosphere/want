...
* Add ``fig.show='animate'`` between the curly brackets of your R-code block (first line, ``{r, fig.show='animate', interval=0.1}``) to create an animation. If the animation does not display in the markdown, open the html in Google Chrome.
</div>
