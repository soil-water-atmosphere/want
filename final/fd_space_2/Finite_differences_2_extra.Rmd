---
title: "Finite differences 2 challenges"
...
<div class="exercise">
<div class="comment">Maybe for the hard question</div></br>
...
<div class="exercise">
Check for the speed of conversion for the central and forward scheme by creating a graph that displays `dx` on the x-axis and the error on the y-axis (average of the absolute differences)
</div>
