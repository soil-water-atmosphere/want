...
dict[5] = "To make the rainfun and evafun available for your code chunk you can add source('topforcing.R') as first line. You can also just run the script separately.";
