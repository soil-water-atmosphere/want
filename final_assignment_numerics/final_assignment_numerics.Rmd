...
```{R run_solvers}
cn_2nd      = solve_cn_2nd      (omega=0.5, dx=0.5, dt=0.5)
cn_4th      = solve_cn_4th      (omega=0.5, dx=0.5, dt=0.5)
cn_pade_4th = solve_cn_pade_4th (omega=0.5, dx=0.5, dt=0.5)
cn_pade_6th = solve_cn_pade_6th (omega=0.5, dx=0.5, dt=0.5)
cn_fft      = solve_cn_fft      (omega=0.5, dx=0.5, dt=0.5)
```
