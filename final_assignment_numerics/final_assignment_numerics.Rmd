...
p = add_trace(p, x=cn_4th_x, y=cn_4th_state, name='cn_4th', mode='lines')
p = add_trace(p, x=cn_pade_4th_x, y=cn_pade_4th_state, name='cn_pade_4th', mode='lines')
p = add_trace(p, x=cn_pade_6th_x, y=cn_pade_6th_state, name='cn_pade_6th', mode='lines')
