...
The usage of four neighboring points delivers fourth-order accuracy, but also introduces inprecise approximation of fine-scale structures due to the wide stencil. Padé, a mathematician that lived at the beginning of 20th century, invented an alternative method (read theory at https://doi.org/10.1016/0021-9991(92)90324-R). Rather than using the Taylor series evaluated at four neighboring points, he used only the left and right neighboring points, but also introduced a Taylor series for the derivative at those points. Schemes that combine Taylor series of neighboring points and their derivatives are called *compact schemes*, because of the small width of the stencil.
$$
